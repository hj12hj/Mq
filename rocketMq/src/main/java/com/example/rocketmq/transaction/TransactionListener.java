...
public class TransactionListener implements RocketMQLocalTransactionListener {
    ...
    @Autowired
    Map<String, LocalTransactionHandle> localTransactionHandleMap;
    ...
    public RocketMQLocalTransactionState executeLocalTransaction(Message message, Object o) {
        ...
        String key = (String) headers.get(RocketMQHeaders.KEYS);
        TRANSACTION_STATE_MAP.put(transactionId, RocketMQLocalTransactionState.UNKNOWN);
        log.info("执行本地事务,transactionId{},key{}", transactionId, key);
        String type = (String) headers.get("type");
        // todo 业务数据处理
//        localTransactionHandleMap.get(type).handleLocalTransaction(key, JSONObject.toJSONString(message.getPayload()));
    ...
    /**
     * 事务状态为 RocketMQLocalTransactionState.UNKNOWN 执行该方法
     * 校验事务状态
     *
     * @param message
     * @return
